            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <aside class="col-12 text-center my-5">
                        <a href="https://pl.wikipedia.org/wiki/Zygmunt_Szendzielarz" target="_blank" title="Przekierowanie do Wikipedii">
                            <h1 class="font-weight-bold text-uppercase ml-0 mb-4 pl-5 pt-1 pb-1 text-center text-md-left bg-jumpers">Zygmunt Szendzielarz
                    ...
                    <div class="col-lg-8 bg-white text-body wpis">
                        ...
                        <header>
                            ...
                            <h1 class="h2 font-weight-bold text-uppercase ml-0 mb-4 text-center text-md-left">Łupaszko bohater czy morderca ?</h1>
                        ...
                        <blockquote class="blockquote">
                            ...
                            <h2 class="h3 font-weight-bold mt-4 mb-4">Olsztyn powojenny </h2>
                            ...
                            <blockquote class="blockquote">
                                <p> Musimy na wstępie wyjaśnić sobie o jakich pieniądzach rozmawiamy, a jest to w istocie bardzo ciekawe. Na dzień przed 1 września 1939 r. w II RP pomoc domowa zarabiała 35 zł, murarz w W-wie 135 zł, a taki Łupaszka jako dowódca brygady zarabiałby miesięcznie 1200 zł. Ideologia była w takiej sytuacji na planie drugim. Żołnierz zawodowy, który tyle lat żył dostatnio na koszt podatnika miał do wyboru kilka opcji honorowych : po pierwsze mógł zginąć na polu chwały, po drugie mógł dostać się do niewoli, po trzecie przedostać się przez granicę i kontynuować walkę. Jeżeli ktoś uciekł z pola walki i po kilku latach wojny zaczął wykonywać wyroki śmierci na rzekomych kolaborantach był po prostu tchórzem. Dla mnie więcej odwagi miał taki sekretarz partii który samotnie szedł organizować oświatę na wsi niż te " tłumoki wyklęte" co pisać i czytać nie potrafili, ale przy pomocy kłonic i siekier, całą bandą pod osłoną nocy go napadli. Przeniesienie ideologi żołnierzy wyklętych jest bardzo wygodne w dzisiejszych czasach zwłaszcza politykom taka opcja robienia niczego bez odpowiedzialności i konsekwencji , bardzo przypadła do gustu . Pozyskiwanie majątków taką metodą na "Łupaszkę" stało się domeną zarówno osób świeckich jak i kościelnych. Metoda jest prosta. Opieka w zamian za przepisanie majątku. Dopóki ofiara może pracować i sama o siebie zadbać jest okey problem zaczyna się w przypadku choroby. Nikt nie zgłasza się po odbiór takich osób i trafiają do hospicjum, co w polskim wydaniu jest wyrokiem śmierci. A pamiętajmy, że ludzie Łupaszki byli partyzantką katolicką , która dzień zaczynała i kończyła różańcem. Z opisów wiemy do czego byli zdolni. Gdy czerpie się z takich wzorców, to nic dziwnego, że moralnie jesteśmy tu gdzie jesteśmy. Gdyby dziś mnie ktoś zapytał. Z czym bym poszedł w 1945 r. na warmińską wieś jako członek bandy z bronią w ręku, czy samotnie z elementarzem pod pachą? Wybrałbym elementarz choć bardzo często było to równoznaczne ze śmiercią.
